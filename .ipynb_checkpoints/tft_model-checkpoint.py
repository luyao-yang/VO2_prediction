...
#       在这一步检查一下attention是否还是4维？ 感觉现在应该只有3维了，如果反正都要减少一维，dim=2多此一举
...
class TemporalFusionTransformer(nn.Module):
    ...
    def define_static_covariate_encoders(self, x):
        ...
        # static_variable_selection网络含有多个GRN拼接 返回的static encoder 只是一个网络的初始化
    ...
    def forward(self, x):
        ...
        # input_columns = ["traffic", "Delta", 'DaysFromStart', 'DayOfWeek', 'DayOfMonth', 'WeekOfYear', 'Month', 'Entity', 'Class', 'Year']
